...
static void* TIMx                 [4] = {TIM2 					,TIM3 					  ,TIM5 					,TIM8 					};
static u32   RCC_APB1Periph_TIMx  [4] = {RCC_APB1Periph_TIM2 	,RCC_APB1Periph_TIM3 	  ,RCC_APB1Periph_TIM5 	    ,RCC_APB2Periph_TIM8 	};

static void* GPIOx                [4] = {GPIOA                  ,GPIOA                    ,GPIOA                    ,GPIOC                  };                       
static u32   RCC_APB2Periph_GPIOx [4] = {RCC_APB2Periph_GPIOA   ,RCC_APB2Periph_GPIOA     ,RCC_APB2Periph_GPIOA     ,RCC_APB2Periph_GPIOC   };                       
static u32   A_GPIO_Pin_x         [4] = {GPIO_Pin_0             ,GPIO_Pin_6               ,GPIO_Pin_0               ,GPIO_Pin_6             };                       
static u32   B_GPIO_Pin_x         [4] = {GPIO_Pin_1             ,GPIO_Pin_7               ,GPIO_Pin_1             	,GPIO_Pin_7				}; 
